...
class VectorMagnitudeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type VectorMagnitudeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type VectorMagnitudeRequest
    let len;
    let data = new VectorMagnitudeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VectorMagnitudeRequest(null);
...
class VectorMagnitudeResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type VectorMagnitudeResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type VectorMagnitudeResponse
    let len;
    let data = new VectorMagnitudeResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VectorMagnitudeResponse(null);
...
module.exports = {
  Request: VectorMagnitudeRequest,
  Response: VectorMagnitudeResponse,
  md5sum() { return '55d1a215f43fd1f64eb105a505b172c4'; },
  datatype() { return 'service_pkg/VectorMagnitude'; }
};
